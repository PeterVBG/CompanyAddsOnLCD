...
Setting a bit in DDRD to 1 makes that pin an output.*/
#define LCD_RS_DIR          DDRD

/*Port Register (PORT)
PORTD is the Output Register for Port D.
Writing 1 to a bit sets the pin HIGH, 0 sets it LOW.*/
#define LCD_RS_PORT         PORTD

/*Bit Mask
PD2 is Pin 2 on Port D.
(1 << PD2) creates a bit mask for that pin.*/
#define LCD_RS              (1 << PD2)
